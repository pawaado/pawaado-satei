...
function basicNameHtml(name){
  let iconHtml='';
  if(name==='魔力'){
    iconHtml=`<svg class="ability-name-svg magic-wand-icon" viewBox="0 0 34 38" aria-hidden="true" focusable="false"><defs><linearGradient id="magicWandShaft" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#a86b2f"/><stop offset=".5" stop-color="#6f411b"/><stop offset="1" stop-color="#3c210f"/></linearGradient><linearGradient id="magicWandGold" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#ffe38c"/><stop offset=".45" stop-color="#dba43a"/><stop offset="1" stop-color="#9f6116"/></linearGradient><linearGradient id="magicWandGem" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#e8fbff"/><stop offset=".42" stop-color="#7ed2ff"/><stop offset="1" stop-color="#2b5e9b"/></linearGradient></defs><path d="M8.2 32.4 19.5 18.2" fill="none" stroke="#44220e" stroke-width="6.2" stroke-linecap="round"/><path d="M8.2 32.4 19.5 18.2" fill="none" stroke="url(#magicWandShaft)" stroke-width="4.1" stroke-linecap="round"/><path d="M7.4 31.6 9.4 34.2" fill="none" stroke="#d8a241" stroke-width="2.2" stroke-linecap="round"/><path d="M18.6 19.5 22.2 14.8" fill="none" stroke="#d8a241" stroke-width="2.3" stroke-linecap="round"/><path d="M20.7 13.7c0-4.4 3.1-8 7-8 3.3 0 5.7 2.5 5.7 5.8 0 4.8-4 8.6-8.8 8.6-1.8 0-3.5-.6-4.9-1.7Z" fill="url(#magicWandGold)" stroke="#6a3d14" stroke-width="1.6" stroke-linejoin="round"/><path d="M23.6 8.7 27.2 6l3.6 2.7v4.5l-3.6 2.7-3.6-2.7Z" fill="url(#magicWandGem)" stroke="#264a77" stroke-width="1.25" stroke-linejoin="round"/><path d="M27.2 6v10.4" fill="none" stroke="#f6fdff" stroke-width="1" opacity=".95"/><path d="M23.6 8.7h7.2" fill="none" stroke="#f6fdff" stroke-width="1" opacity=".55"/><path d="M20.8 10.4c1.8-1 2.5-2.7 2.8-4.1" fill="none" stroke="#f3d487" stroke-width="1.3" stroke-linecap="round" opacity=".9"/></svg>`;
  }else if(name==='耐久力'){
